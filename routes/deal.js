...
router.get('/', function(req, res, next) {
    ...
    console.log('P',vars.playerArray,'score',vars.playerScore,'split',vars.playerCanSplit,'canDouble',vars.playerCanDouble,'NBLJ',vars.naturalBlackjackPlayer,'bank',vars.playersBank);

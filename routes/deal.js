...
var natBJack = require('../models/checkNaturalBJ');
...
router.get('/', function(req, res, next) {
    ...
    natBJack();
    //need to check if the dealer has and ace - face up && if the player has a natural black jack
    ...
    console.log('is this a natural blackjack');
    console.log(score.naturalBlackjack);
